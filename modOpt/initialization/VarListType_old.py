...
class VarListType:
    def __init__(self, type=TYPE_VARIABLE, performSampling=False, numberOfSamples=0, samplingMethod='Sobol', samplingDistribution='uniform', seed=None, sampleData=[], time=[], snapshotDict={},
                 model = None, boxID=0):
    ...
    def add(self, varName, value=[], lowerBound=-1.0e9, upperBound=1.0e9, modelVarID ='', engUnit='-', time=[], controlTime=None, samplingDistribution=None,distributionParams=()):
