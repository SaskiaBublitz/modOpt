...
def lhs(n, samples=None, criterion=None, iterations=None, seed=None):
    """
...
def _lhsclassic(n, samples, seed):
...
def _lhscentered(n, samples, seed):
    # Generate the intervals
    cut = np.linspace(0, 1, samples + 1)    
