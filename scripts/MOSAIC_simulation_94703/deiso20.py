...
def getEquationsVariablesAndParameters(dict_options):
    ...
    xInitial[89] = mpmath.mpi(-1.0E8, 1.0E8)  	# e0_Q_D
    xInitial[90] = mpmath.mpi(0.0, 100.0)  	# e0_R_Reflux
    xInitial[91] = mpmath.mpi(0.0, 500.0)  	# e0_T_D
    ...
    xInitial[98] = mpmath.mpi(-1.0E8, 1.0E8)  	# e0_Q_Reboiler
    xInitial[99] = mpmath.mpi(-1.0E9, 500.0)  	# e0_T_Reboiler
