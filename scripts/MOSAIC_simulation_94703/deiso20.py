...
def getEquationsVariablesAndParameters(dict_options):
    ...
    xInitial[86] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_F_DLn
    xInitial[87] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_K_D_i1
    xInitial[88] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_K_D_i2
    xInitial[89] = mpmath.mpi(-1.0E10, 1.0E10)  	# e0_Q_D
    xInitial[90] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_R_Reflux
    xInitial[91] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_T_D
    xInitial[92] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_p_DL
    ...
    xInitial[96] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_K_Reboiler_i1
    xInitial[97] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_K_Reboiler_i2
    xInitial[98] = mpmath.mpi(-1.0E10, 1.0E10)  	# e0_Q_Reboiler
    xInitial[99] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_T_Reboiler
    xInitial[100] = mpmath.mpi(1.0E-6, 0.1)  	# e0e1_greek_eta_L_tr2
    xInitial[101] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_p_ReboilerV
    ...
    xInitial[283] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_F_LReboilerinn
    xInitial[284] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_F_DLRefluxn
    ...
    xInitial[306] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_F_DVn
    ...
    xInitial[326] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_F_ReboilerVn
    ...
    xInitial[489] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_LReboilern
    xInitial[490] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_Fn
    xInitial[491] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_DLn
    ...
    xInitial[511] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_LReboilerinn
    xInitial[512] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_DVn
    ...
    xInitial[532] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_h_ReboilerVn
    ...
    xInitial[552] = mpmath.mpi(-1.0E9, 1.0E9)  	# e0_p_LReboiler
