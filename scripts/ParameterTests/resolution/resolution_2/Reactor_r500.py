...
# Solver settings:
    dict_options = {"fileName": "Reactor_r500",
                    "iterMaxNewton": 15,
...
def getEquationsVariablesAndParameters(dict_options):
    ...
    xInitial[56] = mpmath.mpi(0.0, 100.0)  	# e0_greek_phiv_LSecR_c1
    ...
    xInitial[87] = mpmath.mpi(-300.0, 0.0)  	# e0_h_SecRV_c1
    xInitial[88] = mpmath.mpi(-300.0, 0.0)  	# e0_h_SecRV_c2
    xInitial[89] = mpmath.mpi(-300.0, 0.0)  	# e0_h_SecRV_c3
    xInitial[90] = mpmath.mpi(-300.0, 0.0)  	# e0_h_SecRV_c4
    xInitial[91] = mpmath.mpi(-300.0, 0.0)  	# e0_h_SecRV_c5
